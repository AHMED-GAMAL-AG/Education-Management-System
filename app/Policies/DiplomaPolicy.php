...
class DiplomaPolicy
{
    ...
    {
        return $user->can('view_any_diploma');
    }
    ...
    {
        return $user->can('create_diploma');
    }
    ...
    {
        return $user->can('update_diploma');
    }
    ...
    {
        return $user->can('delete_diploma');
    }
    ...
    {
        return $user->can('delete_any_diploma');
    }
     ...
     */
    public function replicate(User $user, Diploma $diploma): bool
    {
