...
class StudyPlanPolicy
{
    ...
    {
        return $user->can('view_any_study::plan');
    }
    ...
    {
        return $user->can('view_study::plan');
    }
    ...
    {
        return $user->can('create_study::plan');
    }
    ...
    {
        return $user->can('update_study::plan');
    }
    ...
    {
        return $user->can('delete_study::plan');
    }
    ...
    {
        return $user->can('delete_any_study::plan');
    }
     ...
     */
    public function replicate(User $user, StudyPlan $studyPlan): bool
    {
